...
public class DetectionsConfiguration {
	 ...
	 * @param findDetectionsPort la porta per trovare le rilevazioni, da passare al costruttore di GetDetectionsService
	 * @param findCharacteristicPort la porta per trovare una caratteristica, da passare al costruttore di
