...
public class AdminsDevicesConfiguration {
  ...
  GetCharacteristicsUseCase getCharacteristicsUseCase(
      FindAllCharacteristicsPort findAllCharacteristicsPort) {
   ...
   * @param findCharacteristicPort la porta per cercare una caratteristica, da passare ala
   *     costruttore di InsertCharacteristicService
  ...
  InsertCharacteristicUseCase insertCharacteristicUseCase(
    ...
    return new InsertCharacteristicService(
        insertCharacteristicPort, findDevicePort, findCharacteristicPort);
  }
   ...
   * @param insertDevicePort la porta per inserire una macchina, da passare aal costruttore di
   *     InsertDeviceService
   * @param createDevice l'istanza di una classe per creare una nuova macchina, da passare al
   *     costruttore di InsertDeviceService
   * @param insertCharacteristicUseCase l'interfaccia che modella il caso d'uso di inserimento di
   *     una caratteristica, da passare al costruttore di InsertDeviceService
   ...
   * @param updateCharacteristicPort la porta per aggiornare una caratteristica, da passare al
   *     costruttore di UpdateCharacteristicArchiveStatusService
  ...
  UpdateCharacteristicArchiveStatusUseCase updateCharacteristicArchiveStatusUseCase(
    ...
    return new UpdateCharacteristicArchiveStatusService(
        findCharacteristicPort, updateCharacteristicPort);
  }
   ...
   * @param updateDeviceArchiveStatus la porta per aggiornare lo stato di archiviazione di una
   *     macchina, da passare al costruttore di UpdateDeviceArchiveStatusService
   ...
   * @param updateDeviceDeactivateStatusPort la porta per aggiornare lo stato di attivazione di una
   *     macchina, da passare al costruttore di UpdateDeviceDeactivateStatusService
  ...
  UpdateDeviceDeactivateStatusUseCase updateDeviceDeactivateStatusUseCase(
    ...
    return new UpdateDeviceDeactivateStatusService(
        findDetailedDevicePort, updateDeviceDeactivateStatusPort);
  }
   ...
   * @param findTinyDeviceByNamePort la porta per cercare una macchina con le informazioni
   *     essenziali, da passare al costruttore di UpdateDeviceNameService
   * @param updateDeviceNamePort la porta per aggiornare il nome di una macchina, da passare al
   *     costruttore di UpdateDeviceNameService
  ...
  UpdateDeviceNameUseCase updateDeviceNameUseCase(
    ...
    return new UpdateDeviceNameService(
        findDetailedDevicePort, findTinyDeviceByNamePort, updateDeviceNamePort);
  }
}
