...
/**
 * Record che rappresenta i dati necessari per la creazione di una nuova caratteristica. Contiene
 * tutti i campi di una caratteristica, meno il suo id, quello della macchina e lo stato di
 * archiviazione Mette a disposizione un builder con valori di default.
 */
