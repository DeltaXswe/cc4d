...
public class UpdateDeviceNameServiceTest {
   ...
   *
   * @throws BusinessException la macchina non è stata trovata o esiste già una macchina con il
   *     nuovo nome
   */
  @Test
  void testDeviceNotFound() throws BusinessException {
    TinyDevice device = new TinyDevice(1, "macchinaNuovoNome");
    UpdateDeviceNameService service =
        new UpdateDeviceNameService(
    ...
    BusinessException exception =
        assertThrows(BusinessException.class, () -> service.updateDeviceName(device));
