...
public class GetDetectionsServiceTest {
	...
	void testGetDetectionsWithOlderThan() throws BusinessException {
		service = new GetDetectionsService(
			new FindAllDetectionsWithOlderThanPortMock(),
			new FindCharacteristicLimitsPortMock()
		);
		...
		DetectionsGroup detections = service.listByCharacteristic(
			...
			1,
			DetectionFilters.builder()
				.withOlderThan(OptionalLong.of(3))
				.build()
		);
	...
	void testGetDetectionsWithNewerThan() throws BusinessException {
		...
		DetectionsGroup detections = service.listByCharacteristic(
			...
			1,
			DetectionFilters.builder()
				.withNewerThan(OptionalLong.of(1))
				.build()
		);
	...
	void testGetEmptyDetections() throws BusinessException {
		service = new GetDetectionsService(
			new FindAllDetectionsEmptyPortMock(),
			new FindCharacteristicLimitsPortMock()
		);
	...
	void testGetNotFoundAndArchived() {
		...
		BusinessException exception = assertThrows(BusinessException.class, () -> service.listByCharacteristic(
			1,
			1,
			DetectionFilters.builder()
				.build()
