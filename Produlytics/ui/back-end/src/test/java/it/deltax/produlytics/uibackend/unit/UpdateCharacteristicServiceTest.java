...
public class UpdateCharacteristicServiceTest {
	...
	void testUpdateCharacteristicWithNoAutoAdjust() throws BusinessException {
		UpdateCharacteristicService service = new UpdateCharacteristicService(
	...
	void testUpdateDuplicateCharacteristic() {
		...
		BusinessException exception = assertThrows(BusinessException.class, () -> service.updateCharacteristic(
			CharacteristicToUpdate.builder()
				.withId(1)
				.withDeviceId(1)
				.withName("pressione")
