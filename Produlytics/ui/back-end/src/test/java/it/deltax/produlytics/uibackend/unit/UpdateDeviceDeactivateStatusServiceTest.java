...
public class UpdateDeviceDeactivateStatusServiceTest {
  ...
  void testDeviceNotFound() throws BusinessException {
    ...
    UpdateDeviceDeactivateStatusService service =
        new UpdateDeviceDeactivateStatusService(
    ...
    BusinessException exception =
        assertThrows(BusinessException.class, () -> service.updateDeviceDeactivateStatus(device));
