...
public class GetDeviceDetailsServiceTest {
  ...
  void testDeviceNotFound() throws BusinessException {
    GetDeviceDetailsService service =
        new GetDeviceDetailsService(
            new GetDeviceDetailsServiceTest.FindDetailedDeviceNotFoundPortMock());

    BusinessException exception =
        assertThrows(BusinessException.class, () -> service.getDeviceDetails(1));
  ...
  void testOk() throws BusinessException {
    GetDeviceDetailsService service =
        new GetDeviceDetailsService(new GetDeviceDetailsServiceTest.FindDetailedDevicePortMock());
