...
public class GetUnarchivedCharacteristicsServiceTest {
	...
	private static final TinyCharacteristic characteristic1 = new TinyCharacteristic(
		1,
		"temperatura"
	);

	private static final TinyCharacteristic characteristic2 = new TinyCharacteristic(
		2,
		"pressione"
	);
	...
	private static class FindAllUnarchivedCharacteristicsPortMock implements FindAllUnarchivedCharacteristicsPort {
		@Override
	...
	private static class FindAllUnarchivedCharacteristicsEmptyPortMock implements FindAllUnarchivedCharacteristicsPort {
		@Override
		public List<TinyCharacteristic> findAllByDeviceId(int deviceId) {
			return Collections.emptyList();
		}
