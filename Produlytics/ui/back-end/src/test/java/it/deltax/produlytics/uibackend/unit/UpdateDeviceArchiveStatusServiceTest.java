...
public class UpdateDeviceArchiveStatusServiceTest {
  ...
  void testDeviceNotFound() throws BusinessException {
    ...
    UpdateDeviceArchiveStatusService service =
        new UpdateDeviceArchiveStatusService(
    ...
    BusinessException exception =
        assertThrows(BusinessException.class, () -> service.updateDeviceArchiveStatus(device));
