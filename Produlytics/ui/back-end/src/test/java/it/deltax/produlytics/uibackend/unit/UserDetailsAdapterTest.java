...
public class UserDetailsAdapterTest {
	...
	void testUsernameNotFound() {
		UserDetailsAdapter service = new UserDetailsAdapter(
			new UserDetailsAdapterTest.FindAccountNotFoundUseCaseMock());
	...
	void testOk() {
		UserDetailsAdapter service = new UserDetailsAdapter(
			new UserDetailsAdapterTest.FindAccountUseCaseMock());
	...
	static class FindAccountUseCaseMock implements FindAccountUseCase {
		@Override
		public Optional<Account> findByUsername(String username) throws BusinessException {
			return Optional.of(new Account("user",
