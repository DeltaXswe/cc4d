package it.deltax.produlytics.api.unit.queue;
...
public class DetectionQueueTest {
	...
	void testNormal() {
		...
		DetectionSerieFactory factory = characteristicId -> {
			...
			return (DetectionSerie) rawDetection -> {
		...
		DetectionQueue queue = new DetectionQueueImpl(60, factory);
