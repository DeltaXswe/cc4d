...
public class ControlChartUtils {
	/**
	 * Questo costruttore privato non è utilizzabile, segnala solo che questa classe non è instanziabile.
	 */
	private ControlChartUtils() {}
	/**
	 * Questo metodo ritorna uno `Stream` di "finestre" della lista sorgente, cioè uno `Stream`
	 * di tutte le liste contenenti valori adiacenti nella lista sorgente.
	 *
