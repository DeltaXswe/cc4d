...
/**
 * Questa interfaccia descrive l'abilità di poter ottenere le ultime rilevazioni di una caratteristica e
 * permette di separare la sua implementazione dalla logica di business.
 */
public interface FindLastDetectionsPort {
	/**
	 * Questo metodo ritorna le ultime `count` rilevazioni della caratteristica specificata,
	 * o meno se non ne esistono abbastanza.
	 *
