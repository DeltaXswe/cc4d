...
public class DetectionsService implements ProcessIncomingDetectionUseCase {
	/**
	 * Un'istanza di `DetectionValidator` a cui delegare il compito di validare una rilevazione in arrivo.
	 */
	private final DetectionValidator detectionValidator;
	/**
	 * Un'istanza di `DetectionQueue` a cui delegare il compito di processare le rilevazioni in background.
	 */
