...
/**
 * Questa classe è un controller di Spring Boot.
 * Il suo ruolo è essere il punto d'entrata delle richieste HTTP all'endpoint /detections
 * e inoltrarle al service della parte di business.
 */
@RestController
...
public class DetectionsController {
	/**
	 * L'istanza di un servizio a cui inoltrare le nuove rilevazioni in entrata e che si occuperà di processarle.
	 */
	 ...
	 *
	 * @param processIncomingDetectionUseCase Il valore per il campo `processIncomingDetectionUseCase`.
	 */
	...
	/**
	 * Questo metodo riceve le richieste HTTP fatte all'API e si occupa d'inoltrarle al relativo servizio di business.
	 *
