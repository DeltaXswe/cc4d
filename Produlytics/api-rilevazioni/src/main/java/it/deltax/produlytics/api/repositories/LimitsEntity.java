...
/**
 * Questa interfaccia descrive il risultato della query definita nel metodo `findLimits`
 * di `CharacteristicRepository`, lasciando a Spring il compito d'implementarla.
 */
public interface LimitsEntity {
	 ...
	 *
	 * @return Il valore della deviazione standard, se è attivato l'auto-adjust, altrimenti un valore arbitrario.
	 */
