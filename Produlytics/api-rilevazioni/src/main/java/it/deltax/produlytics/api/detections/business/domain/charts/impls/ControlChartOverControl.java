...
/**
 * Questa classe implementa la carta di controllo descritta in ROF24.8,
 * cioè identifica se 14 punti consecutivi sono a zig-zag.
 */
public class ControlChartOverControl implements ControlChart {
	...
	public void analyzeDetections(List<? extends MarkableDetection> detections, ControlLimits limits) {
		...
		boolean isOverControl = ControlChartUtils.windows(detections, 3).allMatch(window -> {
