...
/**
 * Questa interfaccia descrive l'abilità di poter cercare i limiti tecnici e di processo di una caratteristica
 * tramite il suo identificativo e permette di separare la sua implementazione dalla logica di business.
 */
