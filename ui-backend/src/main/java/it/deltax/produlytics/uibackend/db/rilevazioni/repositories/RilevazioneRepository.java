...
public interface RilevazioneRepository extends CrudRepository<Rilevazione, Long> {
    ...
    @Query("select r from Rilevazione r where r.macchina = :macchina and r.caratteristica = :caratteristica and r.creazioneUtc > :creazione_utc order by creazione_utc")
