package it.deltax.uibackend.db.configurazione;
...
@EnableJpaRepositories(
        basePackages            = { "it.deltax.uibackend.db.configurazione.repository" },
...
public class ConfigurazioneDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean configurazioneEntityManager(
        ...
        return builder
                ...
                .packages("it.deltax.uibackend.db.configurazione.model")      // package da scannerizzare per le @Entity
